...
namespace PriemLib
{
    ...
    {
        public const string CS_PRIEM = "Data Source=SRVEDUCATION;Initial Catalog=Priem2017;Integrated Security=SSPI";
        public const string CS_PRIEM_PING = "Data Source=SRVEDUCATION;Initial Catalog=Priem2017;Integrated Security=false;user=PriemPingUser; password=PriemPingUser_ReadOnly;Connect Timeout=300";
        //PriemSECOND
        public const string CS_PRIEM_SECOND = "Data Source=SRVEDUCATION;Initial Catalog=PriemSECOND;Integrated Security=SSPI";
        ...
        public const string CS_PRIEM_FAC = "Data Source=SRVEDUCATION;Initial Catalog=Priem_TEST;Integrated Security=false; user=Priem2014TestUser; password=Priem2014TestUser; Connect Timeout=10";
        public const string CS_STUDYPLAN = "Data Source=SRVEDUCATION;Initial Catalog=Education;Integrated Security=true";
    }
