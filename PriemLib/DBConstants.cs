...
namespace PriemLib
{
    ...
    {
        public const string CS_PRIEM = "Data Source=81.89.183.112;Initial Catalog=Priem2017;Integrated Security=SSPI";
        public const string CS_PRIEM_PING = "Data Source=81.89.183.112;Initial Catalog=Priem2017;Integrated Security=false;user=PriemPingUser; password=PriemPingUser_ReadOnly;Connect Timeout=300";
        //PriemSECOND
